...
public class DLDatabaseHelper extends SQLiteOpenHelper {
	...
	public void delete(int taskHashCode) {
		synchronized (LOCK) {
			...
			ZWLogger.printLog(DLDatabaseHelper.class, "ɾ���߳���������,ɾ������:" + num);
			mDatabase.close();
		}
	}
	...
	public void updateTask(DLTask mDLTask) {
		synchronized (LOCK) {
			...
			ZWLogger.printLog(DLDatabaseHelper.class, "�����߳���������,�߳�id:" + i);
			if (mDatabase.isOpen()){
				mDatabase.close();
			}
			return;
	...
	public void updateThreadTask(DLTask task,DLThreadTask dtTask) {
		synchronized (LOCK) {
			...
			ZWLogger.printLog(DLDatabaseHelper.class, "�����߳���������,Ӱ������:" + num);
			...
			ZWLogger.printLog(DLDatabaseHelper.class, "�����߳���������,Ӱ������:" + tNum);
			if (mDatabase.isOpen()){
				mDatabase.close();
			}
		}
